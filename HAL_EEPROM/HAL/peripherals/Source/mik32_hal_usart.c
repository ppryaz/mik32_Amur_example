...
__attribute__((weak)) void HAL_USART_MspInit(USART_HandleTypeDef* setting)
{
    ...
    if (setting->Instance == UART_0)
    {
        ...
        /* TXD */
        if (setting->transmitting) GPIO_InitStruct.Pin |= PORT0_6;
        /* RXD */
        if (setting->receiving) GPIO_InitStruct.Pin |= PORT0_5;
        /* RTS */
        if (setting->Modem.rts) GPIO_InitStruct.Pin |= PORT0_8;
        /* CTS */
        if (setting->Modem.cts) GPIO_InitStruct.Pin |= PORT0_7;
        GPIO_InitStruct.Mode = HAL_GPIO_MODE_SERIAL;
        GPIO_InitStruct.Pull = HAL_GPIO_PULL_NONE;
        HAL_GPIO_Init(GPIO_0, &GPIO_InitStruct);
        GPIO_InitStruct.Pin = 0;
        /* XCK */
        if (setting->mode == Synchronous_Mode) GPIO_InitStruct.Pin |= PORT0_5;
        /* DDIS */
        if (setting->Modem.ddis) GPIO_InitStruct.Pin |= PORT0_6;
        /* DTR */
        if (setting->Modem.dtr) GPIO_InitStruct.Pin |= PORT1_12;
        /* DCD */
        if (setting->Modem.dcd) GPIO_InitStruct.Pin |= PORT1_13;
        /* DSR */
        if (setting->Modem.dsr) GPIO_InitStruct.Pin |= PORT1_14;
        /* RI */
        if (setting->Modem.ri) GPIO_InitStruct.Pin |= PORT1_15;
    ...
    if (setting->Instance == UART_1)
    {
        ...
        /* TXD */
        if (setting->transmitting) GPIO_InitStruct.Pin |= PORT1_9;
        /* RXD */
        if (setting->receiving) GPIO_InitStruct.Pin |= PORT1_8;
        /* RTS */
        if (setting->Modem.rts) GPIO_InitStruct.Pin |= PORT1_11;
        /* CTS */
        if (setting->Modem.cts) GPIO_InitStruct.Pin |= PORT1_10;
        GPIO_InitStruct.Mode = HAL_GPIO_MODE_SERIAL;
        GPIO_InitStruct.Pull = HAL_GPIO_PULL_NONE;
        HAL_GPIO_Init(GPIO_1, &GPIO_InitStruct);
        GPIO_InitStruct.Pin = 0;
        /* XCK */
        if (setting->mode == Synchronous_Mode) GPIO_InitStruct.Pin |= PORT2_6;
        // /* DDIS */
        if (setting->Modem.ddis) GPIO_InitStruct.Pin |= PORT2_7;
        /* DTR */
        if (setting->Modem.dtr) GPIO_InitStruct.Pin |= PORT2_0;
        /* DCD */
        if (setting->Modem.dcd) GPIO_InitStruct.Pin |= PORT2_1;
        /* DSR */
        if (setting->Modem.dsr) GPIO_InitStruct.Pin |= PORT2_2;
        /* RI */
        if (setting->Modem.ri) GPIO_InitStruct.Pin |= PORT2_3;
        GPIO_InitStruct.Mode = HAL_GPIO_MODE_TIMER_SERIAL;
        GPIO_InitStruct.Pull = HAL_GPIO_PULL_NONE;
