...
../HAL/peripherals/Source/mik32_hal_eeprom.c \
...
./HAL/peripherals/Source/mik32_hal_eeprom.o \
...
./HAL/peripherals/Source/mik32_hal_eeprom.d \
...
./HAL/peripherals/Source/mik32_hal_usart.d 
...
HAL/peripherals/Source/%.o: ../HAL/peripherals/Source/%.c HAL/peripherals/Source/subdir.mk
	...
	riscv64-unknown-elf-gcc -march=rv32imc_zicsr_zifencei -mabi=ilp32 -msmall-data-limit=8 -mstrict-align -mno-save-restore -Og -ffunction-sections  -g3 -DMIK32V2 -I"C:\MikronIDE\workspace\HAL_EEPROM\src\core" -I"C:\MikronIDE\workspace\HAL_EEPROM\src\periphery" -I"C:\MikronIDE\workspace\HAL_EEPROM\HAL\core\Include" -I"C:\MikronIDE\workspace\HAL_EEPROM\HAL\peripherals\Include" -std=gnu11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
