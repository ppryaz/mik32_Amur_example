...
extern const unsigned char avrIp[];
...
unsigned char ArpWhoIs(unsigned char *buffer, const unsigned char destIp[IP_V4_ADDRESS_SIZE], unsigned char destMac[MAC_ADDRESS_SIZE]); //IP_V4_ADDRESS_SIZE
#endif
